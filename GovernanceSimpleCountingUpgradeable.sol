...
import "@openzepplin/contracts/proxy/utils/Initializable.sol";
...
abstract contract GovernorCountingSimpleUpgradeable is Initializable, GovernorUpgradeable {
        ...
        )
    {
        ...
        return (proposalvote.againstVotes, proposalvote.forVotes, proposalvote.abstainVotes, proposalvote.noWithVetoVotes);
    }
    ...
    function _countVote(
        ...
        } else if (support == uint8(VoteType.NoWithVeto)) {
            proposalvote.noWithVetoVotes += weight;
        } else {
